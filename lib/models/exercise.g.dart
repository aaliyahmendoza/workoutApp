...
void _exerciseSerialize(
  ...
  writer.writeString(offsets[1], object.gifUrl);
...
Exercise _exerciseDeserialize(
  ...
  final object = Exercise(
    ...
    gifUrl: reader.readStringOrNull(offsets[1]),
...
extension ExerciseQueryFilter
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> durationIsNull() {
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> durationIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> gifUrlIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'gifUrl',
      ));
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> gifUrlIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'gifUrl',
      ));
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> gifUrlEqualTo(
    String? value, {
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> gifUrlGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> gifUrlLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> gifUrlBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> gifUrlStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> gifUrlEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> gifUrlContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> gifUrlMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> gifUrlIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'gifUrl',
        value: '',
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> gifUrlIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'gifUrl',
        value: '',
